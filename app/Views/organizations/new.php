...
<div class="container my-3 py-3">
  ...
  <form class="form-group" action="<?= base_url() ?>/organizations/new" method="post">
    <?= csrf_field() ?>
...
$(document).ready(function(){
  ...
  $("#organization").change(function(){uniqueCheck("<?= base_url() ?>/organizations/uniqueCheck", "#organization");});
});
</script>
