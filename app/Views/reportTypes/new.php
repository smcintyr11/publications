...
<div class="container my-3 py-3">
  ...
  <form class="form-group" action="<?= base_url() ?>/reportTypes/new" method="post">
    <?= csrf_field() ?>
...
$(document).ready(function(){
  ...
  $("#reportType").change(function(){uniqueCheck("<?= base_url() ?>/reportTypes/uniqueCheckRT", "#reportType", null);});
  $("#abbreviation").change(function(){uniqueCheck("<?= base_url() ?>/reportTypes/uniqueCheckAB", "#abbreviation", null);});
});
</script>
