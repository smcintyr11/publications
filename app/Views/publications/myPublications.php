...
<div class="container my-3 my-3">
  ...
  <form class="form-inline" action="<?= base_url() ?>/publications/myPublications/1" method="post" id="frmSearch">
    <?= csrf_field() ?>
    ...
    <a class="btn btn-info m-1" href="<?= base_url() ?>/publications/myPublications/1?filter=">Reset</a>
  </form>
