    ...
    <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu">
                <a class="dropdown-item" href="/clients/index/id_asc/25/1">Clients</a>
                <a class="dropdown-item" href="/costCentres/index/id_asc/25/1">Cost Centres</a>
                <a class="dropdown-item" href="/fiscalYears/index/id_asc/25/1">Fiscal Years</a>
                <a class="dropdown-item" href="/journals/index/id_asc/25/1">Journals</a>
